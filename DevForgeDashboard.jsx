...
const css = `
  ...
  .df{
    ...
    background:linear-gradient(-45deg,#0d1f3a,#122848,#0c1a30,#102240,#0d1f3a);
  ...
  .df::before{
    ...
    background:radial-gradient(circle,rgba(0,160,255,.55) 0%,rgba(0,80,220,.30) 40%,transparent 70%);
    filter:blur(40px);
    animation:aurora 14s ease-in-out infinite;
  }
  .df::after{
    width:900px;height:900px;bottom:-260px;right:-140px;
    background:radial-gradient(circle,rgba(20,80,240,.45) 0%,rgba(0,120,255,.28) 45%,transparent 70%);
    filter:blur(36px);
  ...
  .df-hdr{
    ...
    background:rgba(10,22,45,.88);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);
  ...
  .df-inp-area{
    ...
    background:rgba(10,22,45,.78);backdrop-filter:blur(12px);
  ...
  .df-settings-drawer{
    ...
    background:#0a1a32;border-left:1px solid rgba(255,255,255,.08);
  ...
  .df-pipe{
    ...
    background:rgba(10,22,45,.65);backdrop-filter:blur(8px);
  }
  ...
  .df-card{
    ...
    background:color-mix(in srgb,var(--c,#00d4ff) 4%,rgba(10,22,45,.45));
    transition:all .3s;position:relative;overflow:hidden;
    animation:stageIn .35s ease-out both;
  }
  .df-card:hover{
    background:color-mix(in srgb,var(--c,#00d4ff) 8%,rgba(10,22,45,.5));
  ...
  .df-tabs{
    ...
    background:rgba(10,22,45,.72);flex-shrink:0;padding:0 8px;
  }
  .df-tab{
  ...
  .df-log{
    ...
    background:rgba(10,22,45,.7);border-left:1px solid rgba(0,180,255,.1);
  ...
  .df-idle-scard{
    ...
    background:color-mix(in srgb,var(--c,rgba(255,255,255,.04)) 6%,rgba(10,22,45,.3));
  ...
  .df-idle-feat{
    ...
    background:color-mix(in srgb,var(--fi-color,rgba(255,255,255,.04)) 6%,rgba(10,22,45,.3));
